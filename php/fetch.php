        ...
        // insert position div here
            ...
            // insert candidate divs here
                ...
                while($cand = $candidates->fetch_assoc()) { // loop through all candidates in a given position
                    ...
                    // display candidate
                    echo "<td><div class='Candidate'><input required type='radio' name='$pos_id' class='agree-term' value = '$can_id'/> Candidate name: ". $can_nm1. " " . $can_nm2  . " Party: " . $cand["party_name"]. "</div></td>";
